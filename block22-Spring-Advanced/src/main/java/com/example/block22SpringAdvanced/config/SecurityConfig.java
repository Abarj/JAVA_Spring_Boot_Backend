...
public class SecurityConfig {
    ...
    // client_security.properties values
    @Value("${app.client.id}")
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.getConfigurer(OAuth2AuthorizationServerConfigurer.class)
                .oidc(Customizer.withDefaults()); // Configuración por defecto del primer filtro
    ...
    public SecurityFilterChain appSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                .formLogin()
                .and() // .and() regresa el mismo objeto httpsecurity para poder seguir trabajando con él
    ...
    @Bean
    public JwtGrantedAuthoritiesConverter jwtGrantedAuthoritiesConverter() { // Crear prefijo personalizado
    ...
    private static final String APPLICATION_OWNER = "Abarj Labs";
}
